  ...
  return (
    <header className="bg-white/90 backdrop-blur-md border-b border-pink-100 sticky top-0 z-50 py-3 shadow-xs">
      <div className="max-w-3xl mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="font-display font-extrabold text-lg text-[#E53350] tracking-tight flex items-center space-x-1.5">
              <span>ELi</span>
              <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-pink-100 text-[#E53350] border border-pink-200">
                4.0
              </span>
            </h1>
        ...
        <span className="text-xs font-bold text-[#E53350] bg-pink-50 px-3 py-1 rounded-full border border-pink-200">
